...
bucket = storage_client.bucket("your-bucket-name-gsd-ai-mx-ulises-unique")
...
def write_metrics_to_bigquery(algo_name, training_time, model_metrics):
    ...
    table_id = "gsd-ai-mx-ulises.ml_ops.bank_campaign_model_metrics"
...
def main():
    input_data_path = "gs://your-bucket-name-gsd-ai-mx-ulises-unique/bank_campaign_data/bank-additional.csv"
    model_name = "xgboost"
